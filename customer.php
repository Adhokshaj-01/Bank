...
<html>
  <head>
    ...
    <title>Customers-Sparks Bank</title>
  ...
  <?php include 'db.php';?>
    ...
    <h2 class="sub-brand">All Customers</h2>
    <!-- tabel -->
    <div class="main">
       <?php
...
echo "<tbody>";
    ...
    <button type="button" class="btn mybtn btn-outline"
      style="border:1px solid black">Send Money</button>
    </a>
    </td>
    </tr>';
}
